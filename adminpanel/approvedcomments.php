...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-th-list"></i> Təsdiqlənmiş Rəylər</h1>
      <p>Təsdiqlənmiş Rəy Listi</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">Təsdiqlənmiş Rəylər</li>
      <li class="breadcrumb-item active"><a href="#">Təsdiqlənmiş Rəy Listi</a></li>
    </ul>
  </div>
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        $request->bindValue(":com_status",(int) 1, PDO::PARAM_INT);
        $request->execute();
        if($s>ceil($sum/$lim))
        {
          $s=1;
        ...
        if($request->rowCount()){
         ?>
         <h3 class="tile-title">Təsdiqlənmiş Rəy Listi (<?php echo $sum;?>)</h3>
      ...
      <ul class="pagination">
         <?php 
              if($sum>$lim)
              {
                 pagination($s,ceil($sum/$lim),'approvedcomments.php?s=');
              }
          ?>
      </ul>
    <?php } else{
     echo '<div class="alert alert-danger">Təsdiqlənmiş Rəy tapılmadı</div>';
   } ?>
 </div>
</div>
</div>
