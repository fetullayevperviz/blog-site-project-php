...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-th-list"></i> Oxunmuş Mesajlar</h1>
      <p>Oxunmuş Mesajlar Listi</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">Oxunmuş Mesajlar</li>
      <li class="breadcrumb-item active"><a href="#">Oxunmuş Mesajlar Listi</a></li>
    </ul>
  </div>
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        $request->bindValue(":status",(int) 1, PDO::PARAM_INT);
        $request->execute();
        if($s>ceil($sum/$lim))
        {
          $s=1;
        ...
        if($request->rowCount()){
         ?>
         <h3 class="tile-title">Oxunmuş Mesajlar Listi (<?php echo $sum;?>)</h3>
      ...
      <ul class="pagination">
         <?php 
              if($sum>$lim)
              {
                 pagination($s,ceil($sum/$lim),'readmessages.php?s=');
              }
          ?>
      </ul>
    <?php } else{
